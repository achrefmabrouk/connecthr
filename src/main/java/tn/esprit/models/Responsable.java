...
public class Responsable extends Employe {
    ...
    public Responsable(int id, String telephone, String nom, String prenom, String sexe, String poste, String departement,
    ...
    public Responsable(String nom, String prenom, String sexe, String telephone, String poste, String departement,
                       String grade, String adresse, double tarifJournalier, String niveau, int joursCongesRestants) {
